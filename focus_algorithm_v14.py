...
# Configuration
# ----------------------
ball_model_path = "models/best.pt"       #trained model
player_model_path = "models/yolov8s.pt"     # default yolo model
video_path = "uploads/tt8.mp4"  # input
output_dir = "output"           # output
padding = 200                   # crop scale
radius = 200                   # player detection radius
key_frame_freq = 20             # frequency
conf_threshold = 0.25           # YOLO ball confidence
lost_ball_max = 40          # how many frames ball lost => go back to uncropped frame
visualization = True
...
out_path = os.path.join(output_dir, "focused_output4.mp4")
...
while True:
    ...
    if next_window_raw is not None and prev_window is not None:
        ...
        # slowly back to full screen without crop
